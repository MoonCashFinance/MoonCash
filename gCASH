...
contract gCASH is IgCASH, ERC20 {
    ...
    constructor(address _migrator, address _sCASH)
        ERC20("Governance CASH", "gCASH", 18)
    {
     ...
     * @param _sCASH address
     */
    function migrate(address _staking, address _sCASH) external override onlyApproved {
        ...
        require(_sCASH != address(0), "Zero address found");
        sCASH = IsCASH(_sCASH);
    }
    ...
    /**
     * @notice pull index from sCASH token
     */
    ...
    /**
        @notice converts gCASH amount to CASH
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts CASH amount to gCASH
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gCASH::getPriorVotes: not yet determined");
